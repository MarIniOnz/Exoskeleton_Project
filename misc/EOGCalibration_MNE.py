...
Also calculate true positives and false positives #last update 11/10/2021 from Annalisa

'''

import numpy as np
import pyxdf
import LSLStreamInfoInterface
...
filepath = r"C:/Users/marti/Desktop/2021_2022/WINTER 2021/Lab Exoskeleton/Python_Programs/pythonbci_git/data/MyomoTest/Martin/EOG_Calibration_01.xdf"
trial_len = 2
thresh_factor = 0.8
...
plt.plot(eog_times,
         ...
         color=trialColor)
plt.plot(eog_times, np.ma.masked_where(detected <= 0, eog),
...
plt.subplots_adjust(left=0.05, bottom=0.05, right=0.95,
                    top=0.95, wspace=0.05, hspace=0.4)
