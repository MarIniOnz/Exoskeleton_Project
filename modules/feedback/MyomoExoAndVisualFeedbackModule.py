...
import time
import globals
from modules.feedback.SinglePacmanFeedbackModule import SinglePacmanFeedbackModule
from modules.module import Module

from misc import log

logger = log.getLogger("MyomoExoAndVisualFeedbackModule")

from modules.feedback import MyomoFeedbackModule, HandElbowFeedbackModule, SinglePacmanFeedbackModule


class MyomoExoAndVisualFeedbackModule(Module):
    # make this a runnable descendant of the module-class
    MODULE_RUNNABLE: bool = True

    MODULE_NAME: str = "Myomo Exo and Visual Feedback Module"
    ...
    def __init__(self):
        ...
        self.module_2 = MyomoFeedbackModule.MyomoFeedbackModule()
    ...
    def start(self):
        ...
        logger.info("Starting HandElbowFeedbackModule...")
        self.module_1.start()
        logger.info("Starting MyomoFeedbackModule...")
        self.module_2.start()
